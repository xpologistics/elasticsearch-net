...
namespace Nest6
{
	...
	{
		/// <summary>
		/// The maximum anomaly score, between 0-100, for any of the bucket influencers. This is an overall, rate-limited score for the job. All the
		...
		/// <summary>
		/// The maximum anomaly_score for any of the bucket influencers. This is the initial value that was calculated at the time the bucket was
		/// processed.
		/// </summary>
