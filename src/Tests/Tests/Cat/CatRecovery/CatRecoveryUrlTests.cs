	...
	public class CatRecoveryUrlTests : UrlTestsBase
	{
		[U] public override async Task Urls()
		{
			...
			await GET("/_cat/recovery/project")
				...
				.Request(c => c.CatRecovery(new CatRecoveryRequest(Nest6.Indices.Index<Project>())))
				.FluentAsync(c => c.CatRecoveryAsync(r => r.Index<Project>()))
				.RequestAsync(c => c.CatRecoveryAsync(new CatRecoveryRequest(Nest6.Indices.Index<Project>())));
		}
	}
}
