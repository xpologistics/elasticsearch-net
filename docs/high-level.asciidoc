...
To interact with Elasticsearch using Nest6, we need to be able to contol how POCO types in our solution
...
on using the {ref_current}/search-search.html[Search API].
