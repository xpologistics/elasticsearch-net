...
IMPORTANT NOTE
==============
This file has been generated from https://github.com/elastic/elasticsearch-net/tree/master/src/Tests/Tests/troubleshooting.asciidoc. 
...
Whilst developing with Elasticsearch using Nest6, it can be extremely valuable to see the requests that
